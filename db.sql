...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Дек 04 2020 г., 11:11
...
(5, 'Уролог', 'Уролог является врачом, который осуществляет диагностику, профилактику и лечение заболеваний мочеполовой системы. Записаться на прием к нему могут как женщины, так и мужчины.'),
(6, 'Окулист', 'Офтальмолог (окулист) — специалист, который занимается диагностикой и лечением различных заболеваний глаз и зрительного нерва. '),
(7, 'Хирург', 'Хирург – врач, специализирующийся на лечении различных заболеваний посредством физического вмешательства в организм пациента. Обычно такие патологии невозможно вылечить медикаментозно, без хирургических манипуляций – перевязок, обработок ран, оперативных вмешательств.'),
(8, 'Психолог', 'Cпециалист, занимающийся изучением проявлений, способов и форм организации психических явлений личности в различных областях человеческой деятельности для решения научно-исследовательских и прикладных задач, а также с целью оказания психологической помощи, поддержки и сопровождения.');
